...
export default function GiftFinderClient({ initialProducts: products }: { initialProducts: Product[] }) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen py-20 relative overflow-hidden">
      ...
      {/* Decorative bg */}
      <div className="absolute top-0 start-0 w-96 h-96 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {steps[currentStep].options.map((option, idx) => (
                    <motion.button
                      ...
                      className="p-6 rounded-3xl border-2 border-slate-100 hover:border-primary hover:bg-primary/5 transition-all duration-300 text-start flex items-center gap-6 group bg-white"
                    >
