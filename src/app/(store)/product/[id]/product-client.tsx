          ...
          >
            <div className="aspect-square bg-slate-100 rounded-3xl overflow-hidden relative group">
              {product.isBestSeller && (
                <Badge className="absolute top-6 start-6 z-10 bg-blue-500 shadow-md text-sm px-3 py-1">الأكثر مبيعاً</Badge>
              )}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="sm:max-w-[425px]" dir="rtl">
                      <DialogHeader>
                        <DialogTitle className="text-start text-xl font-bold">تقييم المنتج</DialogTitle>
                      </DialogHeader>
                      <div className="py-4 space-y-4">
                        ...
                        <div>
                          ...
                          <Textarea placeholder="شاركنا رأيك بالمنتج..." className="resize-none h-24 rounded-xl text-start" dir="rtl" />
                        </div>
                      </div>
