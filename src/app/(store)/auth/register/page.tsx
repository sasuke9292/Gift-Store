    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-800">إنشاء حساب جديد</h2>
          <p className="mt-2 text-sm text-slate-500">انضم إلينا واكتشف عالم الهدايا الرائع</p>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input 
                  ...
                  className="pl-4 pr-12 h-12 bg-slate-50 rounded-xl border-transparent focus:bg-white" 
                  required
                />
              </div>
            </div>
