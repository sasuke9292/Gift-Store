        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-80 shrink-0">
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 mb-6 text-center relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-br from-primary/10 to-blue-500/10"></div>
              ...
              <div className="relative mb-6 mx-auto w-28 h-28">
                ...
                <button className="absolute bottom-0 left-0 bg-white p-2 rounded-full shadow-md border border-slate-100 text-slate-600 hover:text-primary transition-colors z-20">
            ...
            <div className="bg-white rounded-[2rem] p-4 shadow-sm border border-slate-100">
              <nav className="space-y-1">
                {tabs.map((tab) => (
                  ...
                  >
                    <div className="flex items-center">
                      <tab.icon className={`w-5 h-5 ml-3 ${activeTab === tab.id ? 'text-white' : 'text-slate-400'}`} />
                      {tab.label}
                    </div>
                    {tab.count !== undefined && (
                ...
                <div className="pt-4 mt-4 border-t border-slate-100">
                  ...
                  >
                    <LogOut className="w-5 h-5 ml-3 text-rose-400" />
                    تسجيل الخروج
                  </button>
                </div>
              </nav>
