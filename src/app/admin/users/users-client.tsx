    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
        ...
        <div className="flex gap-3">
          ...
          >
            <UserCog className="w-5 h-5 me-2" />
            إضافة مستخدم
          </Button>
          <Button 
                              ...
                              <DropdownMenuContent align="end" className="w-48 rounded-2xl shadow-xl border-slate-100 p-2">
                                ...
                                >
                                  {user.status === 'نشط' ? (
                                    ...
                                    <>
                                      <CheckCircle2 className="me-3 h-4 w-4" />
          ...
          {selectedUser && (
            <form onSubmit={handleSaveEdit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input defaultValue={selectedUser.email} dir="rtl" className="h-12 rounded-xl border-slate-200 focus-visible:ring-indigo-500 bg-slate-50 focus:bg-white text-end" />
              </div>

              <div className="space-y-2">
                <label className="text-sm font-bold text-slate-700">تغيير كلمة المرور</label>
                <Input type="password" placeholder="أدخل كلمة المرور الجديدة (اختياري)" dir="rtl" className="h-12 rounded-xl border-slate-200 focus-visible:ring-indigo-500 bg-slate-50 focus:bg-white text-end placeholder:text-start" />
