              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <Input 
                    ...
                    dir="rtl" 
                    className="h-12 rounded-xl border-slate-200 focus-visible:ring-indigo-500 bg-slate-50 focus:bg-white font-mono text-sm text-end" 
                  />
                </div>
              </div>
              <div className="space-y-3">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="border-2 border-dashed border-slate-200 rounded-2xl p-6 flex flex-col items-center justify-center text-center bg-slate-50 hover:bg-indigo-50/50 hover:border-indigo-300 transition-all cursor-pointer relative group">
                  ...
                  <p className="text-sm font-bold text-slate-700 mb-1">اضغط أو اسحب الصور من جهازك هنا</p>
                </div>
                ...
                <div className="flex gap-2 mt-3">
                  <Input 
                    ...
                    className="flex-1 bg-slate-50 border-slate-200 focus-visible:ring-indigo-500 rounded-xl h-11 text-sm text-end"
                    dir="rtl"
                  />
                  <Button 
                    type="button" 
                    onClick={handleAddImageUrl}
                    className="h-11 rounded-xl bg-indigo-100 text-indigo-700 hover:bg-indigo-200 shadow-none font-bold px-6"
                  >
                    إضافة الرابط
                  </Button>
                </div>
                    ...
                    {formData.imagesList.map((img, idx) => (
                      <div key={idx} className="relative aspect-square rounded-xl overflow-hidden border border-slate-100 group shadow-sm">
                        ...
                        <button 
                          ...
                          className="absolute top-1 start-1 bg-white/90 w-6 h-6 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 hover:bg-rose-50 hover:text-rose-600 shadow-sm"
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </div>
